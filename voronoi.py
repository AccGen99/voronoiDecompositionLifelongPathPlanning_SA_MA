...
class voronoi_decomposer:
    ...
    def make_gif(self):
        with imageio.get_writer('workload_balance__{}centres.gif'.format(len(self.centres)), mode='I', duration=1.0) as writer:
    ...
    def plot_centres(self, centre_objects, std_dev):
        ...
        plt.suptitle('workload std_dev - ' + str(std_dev))
    ...
    def get_virtual_velocities(self, forces, centre_objects, velocities):
        viscous = np.random.rand(len(self.centres), 2)
        final_velocities = []
